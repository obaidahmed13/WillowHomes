        ...
        <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-6">
            <div className="flex flex-col gap-4 flex-1">
                ...
                <div className="flex flex-wrap gap-6">
                    ...
                    <div className="flex items-center gap-2">
                        <input type="number" id="regularPrice" min='1000' max= '10000000' required 
                        className="p-3 border border-gray-400 rounded-lg"
            ...
            <div className="flex flex-col flex-1 gap-4">
                ...
                <div className="flex gap-4">
                    <input 
                      ...
                      accept='image/*' 
                      multiple />
                    <button type='button' onClick={handleImageSubmit} className="p-3 text-blue-700 border border-gray-500 rounded uppercase hover:shadow-lg">{uploading? 'Uploading...': 'Upload'}</button>
                </div>
                ...
                <button className="p-3 bg-slate-600 text-white rounded-lg uppercase hover:opacity-80">{loading? 'Creating...': 'Create Listing'}</button>
